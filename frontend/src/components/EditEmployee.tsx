  ...
  const fetchEmployee = async () => {
    try {
      ...
      setFormData({
        ...
        typeContrat: employee.typeContrat || 'fixe',
        tauxSalaire: employee.tauxSalaire ? employee.tauxSalaire.toString() : '',
        coordonneesBancaires: employee.coordonneesBancaires || '',
        entrepriseId: employee.entrepriseId ? employee.entrepriseId.toString() : ''
      });
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-[#F4EBD3]">
      <header className="bg-[#DED3C4] shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          <h1 className="text-3xl font-bold text-[#555879]">Modifier l'employé</h1>
          <button
